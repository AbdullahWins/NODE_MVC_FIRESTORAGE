...
const sendInvoiceAlertToBusiness = async ({ data, subject }) => {
  try {
    // Read EJS template file
    const templatePath = path.join(
      __dirname,
      "../../views/emails/QuotationAlertForBusiness.ejs"
    );
    ...
    const mailOptions = {
      ...
      to: "abdudevs@gmail.com", //data?.business?.email,
      subject: subject,
      // attachments: [
      //   {
...
module.exports = { sendInvoiceAlertToBusiness };
